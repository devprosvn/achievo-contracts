...
let AchievoContract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = view(), _dec10 = view(), _dec11 = view(), _dec12 = call({
  payableFunction: true
}), _dec13 = view(), _dec14 = view(), _dec15 = view(), _dec(_class = (_class2 = class AchievoContract {
  // Storage collections
  ...
  register_individual({
    ...
    log(`Individual registered: ${caller} - ${name}`);
  }
  ...
  register_organization({
    ...
    log(`Organization registered: ${caller} - ${name} (pending verification)`);
  }
  ...
  verify_organization({
    ...
    log(`Organization verified: ${organization_id}`);
  }
  ...
  issue_certificate({
    ...
    log(`Certificate issued: ${certificate_id} for ${learner_id}`);
  ...
  update_certificate_status({
    ...
    log(`Certificate ${certificate_id} status updated to: ${new_status}`);
  }
  ...
  revoke_certificate({
    ...
    this.certificate_history.set(certificate_id, history);
    log(`Certificate ${certificate_id} revoked. Reason: ${reason}`);
  }
  ...
  grant_reward({
    ...
    log(`Reward granted: ${reward_id} to ${learner_id} for ${milestone}`);
    return reward_id;
  }
  ...
  process_payment({
    ...
    const promise = promiseBatchCreate(recipient_id);
    promiseBatchActionTransfer(promise, payment_amount);
    promiseReturn(promise);
    log(`Payment processed: ${sender} -> ${recipient_id}, amount: ${amount}`);
  }
...
}, _applyDecoratedDescriptor(_class2.prototype, "register_individual", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "register_individual"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "register_organization", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "register_organization"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "verify_organization", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "verify_organization"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "issue_certificate", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "issue_certificate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_certificate_status", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "update_certificate_status"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "revoke_certificate", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "revoke_certificate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "grant_reward", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "grant_reward"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "list_rewards", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "list_rewards"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "validate_certificate", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "validate_certificate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_certificate_history", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "get_certificate_history"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "process_payment", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "process_payment"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_individual", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "get_individual"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_organization", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "get_organization"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_certificate", [_dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "get_certificate"), _class2.prototype), _class2)) || _class);
function get_certificate() {
  const _state = AchievoContract._getState();
  if (!_state && AchievoContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = AchievoContract._create();
  if (_state) {
    AchievoContract._reconstruct(_contract, _state);
  }
  const _args = AchievoContract._getArgs();
  const _result = _contract.get_certificate(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function get_organization() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.get_organization(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function get_individual() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.get_individual(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function process_payment() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.process_payment(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function get_certificate_history() {
  const _state = AchievoContract._getState();
  if (!_state && AchievoContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.get_certificate_history(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function validate_certificate() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.validate_certificate(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function list_rewards() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.list_rewards(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function grant_reward() {
  const _state = AchievoContract._getState();
  if (!_state && AchievoContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.grant_reward(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function revoke_certificate() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.revoke_certificate(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function update_certificate_status() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.update_certificate_status(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function issue_certificate() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.issue_certificate(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function verify_organization() {
  const _state = AchievoContract._getState();
  if (!_state && AchievoContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.verify_organization(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function register_organization() {
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.register_organization(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}
function register_individual() {
  const _state = AchievoContract._getState();
  if (!_state && AchievoContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AchievoContract._getArgs();
  const _result = _contract.register_individual(_args);
  AchievoContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AchievoContract._serialize(_result, true));
}

export { AchievoContract, get_certificate, get_certificate_history, get_individual, get_organization, grant_reward, issue_certificate, list_rewards, process_payment, register_individual, register_organization, revoke_certificate, update_certificate_status, validate_certificate, verify_organization };
//# sourceMappingURL=achievo.js.map
